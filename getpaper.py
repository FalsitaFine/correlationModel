...
link_proto = "http://www.freebooks4doctors.com/link.php?id="
#pdf test: /link.php?id=1503
out_proto = "./paper_list/"
index_range = 3000

for i in range(2000,index_range):

	print("Trying #  ", i)

	link = link_proto + str(i)
	try:
